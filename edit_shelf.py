...
class EditShelfDialog(QDialog):
    def __init__(self, cur, config, name):
        ...
        self.sql_browser.setPlainText(SQLify(self.ui.filterEdit.toPlainText(), shelf_config["limit"], shelf_config["shuffle"]))
        self.ui.verticalLayout.insertWidget(self.ui.verticalLayout.count() - 1, self.sql_label)
        self.ui.verticalLayout.insertWidget(self.ui.verticalLayout.count() - 1, self.sql_browser)
