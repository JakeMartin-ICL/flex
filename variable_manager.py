...
class VariableManagerDialog(QDialog):
    ...
    def append_to_table(self, var, min, max):
        ...
        self.ui.tableWidget.setItem(self.ui.tableWidget.rowCount()-1, 0, var_item)
        self.ui.tableWidget.setItem(self.ui.tableWidget.rowCount()-1, 1, min_item)
        self.ui.tableWidget.setItem(self.ui.tableWidget.rowCount()-1, 2, max_item)
    ...
    def add_variable(self):
        ...
        self.cur.execute("INSERT INTO variables (variable, min, max) VALUES (?, ?, ?)", (new_variable, min, max))
    ...
    def remove_variable(self):
        ...
        for variable in variables:
            self.cur.execute("DELETE FROM variables WHERE variable = ?", (variable.data(),))
